# Create an enhanced interactive interface that supports all the new backends
enhanced_interface = '''
"""
...
with open("enhanced_pdf_gui.py", "w") as f:
    f.write(enhanced_interface)

print("Created enhanced interactive GUI with support for all AI backends")