# Create a GUI version using tkinter for even better user experience
gui_extractor = '''
"""
...
with open("gui_extractor.py", "w") as f:
    f.write(gui_extractor)

print("Created GUI version of the PDF extractor: gui_extractor.py")