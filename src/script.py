# Create an enhanced interactive PDF extractor with user selection capabilities
...
with open("interactive_extractor.py", "w") as f:
    f.write(interactive_extractor)

print("Created enhanced interactive PDF extractor: interactive_extractor.py")